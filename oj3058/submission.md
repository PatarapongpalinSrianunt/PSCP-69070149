...
input 2: ตัวแปร b
input 3: ตัวแปร goal
output : เป็นจำนวนอิฐก้อนเล็กที่ต้องใช้
ถ้าไม่สามารถสร้างได้ ตอบ -1
โดยที่เราต้องใช้ก้อนใหญ่ให้หมดก่อนแล้วถ้ายังขาดอีกต้องใช้ก้อนเล็กที่เหลือเท่าไหร่
```
...
ถ้าไม่สามารถสร้างได้ ตอบ -1
โดยที่เราต้องใช้ก้อนใหญ่ให้หมดก่อนแล้วถ้ายังขาดอีกต้องใช้ก้อนเล็กที่เหลือเท่าไหร่
ใช้ use_big = min(b , goal // 5) เพื่อหาว่าใช้ก้อนใหญ่ได้เท่าไหร่
จากนั้นคำนวณ ก้อนที่เหลือที่ต้องใช้จาก remaining_length = goal - (use_big * 5)
ถ้า a >= remaining_length
ให้แสดงผลจำนวนที่เหลือที่ต้องใช้
ถ้า a ไม่พอให้แสดงผล -1
```
...
```text
เทสว่าถ้าก้อนอิฐไม่พอจะแสดงยังไง
```
