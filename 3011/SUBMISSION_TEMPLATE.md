...
```text
Step 1: กำหนดรับ Input ชื่อสีทั้ง 2 บรรทัด
Step 2: รวมสีทั้งสองเข้าด้วยกันเป็นเซต
Step 3: กำหนดนิยามแม่สี
Step 4: ตรวจสอบว่าสีที่กรอกเข้ามาเป็นแม่สีทั้งคู่หรือไม่
Step 5: ตั้งกรณีต่างๆ
Step 6: หากมีสีอื่นที่ไม่ใช่แม่สีปนมา ให้ตอบ Error
```
