...
```text
input 1 จํานวนนับ A :
input 2 จํานวนนับ B : (โดยที่ B > A)
input 3 จํานวนนับ d (ตัวหาร) :
input 4 จํานวนนับ r (เศษ) : (โดยที่ r < d)
output : มีจํานวนนับ x ในช่วง [A , B] กี่จํานวน ที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
ใช้ for loop และ if ในการเช็คว่าเข้าเงื่อนไขรึป่าวและ count ออกมาเป็น output
```
