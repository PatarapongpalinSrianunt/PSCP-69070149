...
```text
รับค่าคะแนนรวมของกรรมการทั้ง 3 คน
รับค่าคะแนนของกรรมการคนที่ให้เยอะที่สุด (คะแนนสูงสุด)
ตรวจว่าคะแนนสูงสุด กับ คะแนนที่ต่ำที่สุด ห่างกันเกิน 2 คะแนนหรือไม่
ถ้าเกินตอบ Surprising
ถ้าไม่ตอบ Not surprising
