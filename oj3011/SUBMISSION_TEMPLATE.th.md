...
```text
เหมือนแผนแรก ผมใช้เซตจะช่วยตัดปัญหาเรื่องลำดับและใช้ subset ใช้เช็กว่าคำที่ป้อนเข้ามา "ทุกคำ" ต้องเป็น 1 ใน 3 แม่สี และ len(mixed_colors) == 1: เป็นการดักกรณีที่ผู้ใช้ป้อนสีเดียวกันทั้ง 2 บรรทัดครับ
```
