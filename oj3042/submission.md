...
```text
รับเลขจำนวนเต็มบวก
ปรับ N ให้กลายเป็นพหุคูณของ 10 ที่มากที่สุดที่ไม่เกิน N
แสดงจำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัวโดยใช้ลูปถอยหลังทีละ 10 ไปจนถึง 0 แล้วแสดงผล
```
...
```text
เหมือนแผนแรก หารพหุคูณของ 10 แล้วใช้ลูปในการวนตอบ
```
