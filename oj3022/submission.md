...
```text
input 1 เป็น อุณหภูมิ
input 2 เป็นหน่วยอุณหภูมิที่เรากำหนด
input 2 เป็นหน่วยอุณหภูมิที่เราต้องการ
output คือค่าที่แปลงเป็นอุณหภูมิหน่วยที่เราต้องการ
ตั้งเงื่อนไขหากรับหน่วยนี้แปลงเป็นหน่วยนี้โดยคำนวณอย่างนี้
```
