...
```text
กำหนด input รับตัวเลขวันกับเดือน
เช็คว่าเดือนหาร 3 ลงตัวและเลยวันที่ 21 รึป่าว ถ้าเลยให้เปลี่ยนฤดู ถ้าไม่เลยให้เป็นฤดูเดิม
```
...
```text
Step 1: กำหนดรับ Input ตัวเลขเดือนและวันที่
Step 2: เช็คว่าเดือนหาร 3 ลงตัวรึป่าวและเลยวันที่ 21 มั้ย
Step 3: ถ้าหารลงตัวและเลยวันที่ 21 แสดงผลฤดูใหม่
Step 4: ถ้าหารไม่ลงตัวให้แสดงฤดูเดิม
```
...
```text
เหมือนแผนแรก เช็คว่าเดือนหาร 3 ลงตัวมั้ยและเลยวันที่ 21 รึยัง แสดง output ออกมาตามแพลนที่ตั้งไว้
```
