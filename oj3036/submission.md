...
```text
input รับหมายเลขห้องที่คุณอยู่
output หาว่าถ้าจะเดินทางไปถึงห้อง 1 จะต้องพังกำแพงน้อยที่สุดกี่กำแพง
หาชั้น R จากรูทหมายเลขห้องที่คุณอยู่
หา C จาก หมายเลขห้องที่คุณอยู่ - ( R - 1) กำลัง 2
ถ้าสามเหลี่ยมชี้ขึ้น (เมื่อ C เป็นเลขคี่) output =  2 x (R-1)
ถ้าสามเหลี่ยมชี้ลง (เมื่อ C เป็นเลขคู่) output =  2 x (R-1) - 1
```
...
```text
เพราะห้องที่ 3 ติดกับ 1 เลยเทสดูว่าผลจะออกมาเป็น 1 มั้ย
```
