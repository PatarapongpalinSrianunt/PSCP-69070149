...
```text
input S แทนพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาที
input N แทนจำนวนคำร้องจากผู้คน
แล้วก็ for loop input พิกัดของบ้านของคนที่ i
output ตอบคำถามของคนที่ i ว่าบ้านของเขาจะถูกน้ำท่วมในวินาทีที่เท่าใด
โดยที่คำนวณจากสูตร (ค่าพาย คูณ (xกำลัง2 + yกำลัง2)) / S
แล้วเอาคำตอบของแต่ละคนมาใส่ไว้ใน list เพื่อแสดง output ออกมาว่าบ้านของแต่ละคนจะถูกน้ำท่วมในวินาทีที่เท่าใด
```
...
```text
ดสอบว่าโปรแกรมจัดการกับจุด (0,0) ได้ถูกต้องไหม
```
...
```text
ใช้ทดสอบceiling และทดสอบการรับค่าพิกัดขนาดใหญ่ตามขอบเขตโจทย์  (0 <= Xi. Yi <= 10000)
```
